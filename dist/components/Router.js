...
function Router({ routes, fallback }) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_router_dom_1.BrowserRouter, { children: (0, jsx_runtime_1.jsxs)(react_router_dom_1.Switch, { children: [switchData, (0, jsx_runtime_1.jsx)(react_router_dom_1.Route, { component: fallback })] }) }));
}
