...
export declare type FunctionComponent<Props = {}> = (props?: Props) => Component;
export declare type Callback<T = void, Arguments extends Array<any> = Array<any>> = (...args: Arguments) => T;
