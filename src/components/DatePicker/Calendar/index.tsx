    ...
    <div className="calendar">
      <header aria-labelledby='calendar-header'>
        ...
        <h1 id="calendar-header">
          <span id="calendar-header__month" title={selectedDate.monthName}>{monthNames[selectedDate.month - 1]}</span>
          <span id="calendar-header__year" title={selectedDate.year.toString()}>{selectedDate.year}</span>
        </h1>
